 ...
 * This class manages the movement forces of robot flockers
 */

public class FlockerMovementForces : MovementForces 
{
	// Attributes
	...
	*/
	...
	override public void SetTransform()
	{
		...
		position.y = behaviourMngr.terrainGenerator.GetHeight(position) + 0.5f;
