 ...
 * This class manages the movement forces of robot leaders
 */

public class LeaderMovementForces : MovementForces 
{
	// Attributes
	...
	*/
	...
	override public void SetTransform()
	{
		...
		position.y = behaviourMngr.terrainGenerator.GetHeight(position) + 0.8f;
